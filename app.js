...
async function vJour(preset) {
  ...
  const open = async (id) => {
    ...
    <button class="btn dark" id="bv">Mark verified</button> <button class="btn ghost" style="color:#000;border:1px solid #ccc" id="bb">Flag bounce</button></div>
